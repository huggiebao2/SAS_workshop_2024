...
其中 <img src="./pic/toolbar-submit-sas-win-env.png" width="18"> 為**提交 (submit)** 程式。
- 無指定程式碼範圍情況下點選 <img src="./pic/toolbar-submit-sas-win-env.png" width="18">，將提交並執行當前所在檔案之所有程式碼。
- 可以框選後再點選 <img src="./pic/toolbar-submit-sas-win-env.png" width="18">，只會提交並執行指定的程式碼部分。

如果需要**中斷 (break)** 程式碼的運行，可以點選 <img src="./pic/toolbar-break-sas-win-env.png" width="18">。
